...
function Conversation() {
    ...
    const loadQuestions = async () => {
      try {
        ...
        if (
          ...
          throw new Error(
            `AI faqat ${uniqueQuestions.length} ta noyob savol qaytardi. 20 ta savol kerak.`
          );
        }
  ...
  }, [scenarioId, isAuthenticated, scenario]);
